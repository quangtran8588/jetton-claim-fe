...
export class JettonMinterV2 implements Contract {
  ...
  async getJettonMinterData(provider: ContractProvider) {
    const result: TupleReader = (await provider.get("get_jetton_data", []))
      .stack;
